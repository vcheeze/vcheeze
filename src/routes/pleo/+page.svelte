...
<div class="container mx-auto my-10 flex gap-10">
  <div class="w-[265px] flex-none font-mono text-[16px]">
    <img src="/images/profile.png" class="h-[265px] w-[265px]" alt="Peter Chen's Profile Pic" />
    <div class="border-b pb-6">
      ...
      <div class="space-y-2">
        ...
        <p>
          ...
          - experienced in Next.js, Remix, and SvelteKit. At home with microservices architecture, and
          dabbled in Python to do some mixed-integer linear programming for my fantasy NBA team.
        </p>
        <p>
  ...
  <div>
    <div class="relative space-y-5 rounded-2xl bg-[#d9f2e1] p-[25px]">
      <h1>Peter Chen</h1>
      <!-- <a
      ...
      <p>
        I am a problem-solver at heart, and the web is simply my medium. Some of my most meaningful
        work includes building a centralized e-services portals that serve millions and a "health
        check" tool which fostered a better work environment for my colleagues. Growing up
        homeschooled made me self-driven and adaptable, which is why I thrive in remote and
    ...
    <div class="section">
      ...
      <div>
        ...
        <p class="text-muted-foreground text-lg italic">
          Abu Dhabi government's e-services portal serving nearly 4 million users - because who has
          the time to look for everything individually?
        </p>
        <ul class="my-6 ml-6 list-disc [&>li]:mt-2">
          ...
          <li>
            Spearheaded another remote team of 13 engineers, stabilizing and enhancing 200+ services
            for the Department of Municipalities and Transport, including 3 of the most used
            services on TAMM
          </li>
          <li>
          ...
          <li>
            Built an interactive kiosk interface deployed across 20+ service centers, allowing users
            to easily submit video, audio, and text feedback
          </li>
        </ul>
        <p class="space-x-2 font-mono text-[13px] leading-[14px]">
          <span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">React</span><span
            class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Redux</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Storybook</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Jest</span><span
            class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Node.js</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">TypeScript</span
        ...
        <ul class="my-6 ml-6 list-disc [&>li]:mt-2">
          <li>
            Designed and built a custom drag-and-drop form editor integrated with Dynamics CRM's for
            seamless data management
          </li>
          <li>
            Developed a dynamic rendering engine for forms created by the custom editor, embedded in
            Next.js
          </li>
          <li>
            Created a component library using Radix primitives, customized Shadcn UI, Storybook, and
            Zeroheight for showcase and documentation
          </li>
        </ul>
        <p class="space-x-2 font-mono text-[13px] leading-[14px]">
          ...
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]"
            >Tailwind CSS</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Zeroheight</span>
        </p>
        ...
        <p class="space-x-2 font-mono text-[13px] leading-[14px]">
          <span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Vue.js</span><span
            class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Aspose.Slides</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]"
      ...
      <div>
        ...
        <p class="space-x-2 font-mono text-[13px] leading-[14px]">
          <span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Remix</span><span
            class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Radix UI</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]"
            >Tailwind CSS</span
      ...
      <div>
        ...
        <ul class="my-6 ml-6 list-disc [&>li]:mt-2">
          ...
          <li>
            Upcoming features: Advanced planning tools to save and compare team strategies, in-depth
            visualizations of player contributions over time, and other fun visualizations and stats
          </li>
        </ul>
        <p class="space-x-2 font-mono text-[13px] leading-[14px]">
          <span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Next.js</span
      ...
      <div>
        ...
        <p class="text-muted-foreground text-lg italic">
          Manage your mammon, and let not your mammon manage you - built for the financial needs of
          my own household.
        </p>
        <ul class="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <p class="space-x-2 font-mono text-[13px] leading-[14px]">
          ...
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]"
            >Shadcn Svelte</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Lucia Auth</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]">Drizzle ORM</span
          ><span class="rounded-[25px] border border-[#333333] px-[14px] py-[7px]"
